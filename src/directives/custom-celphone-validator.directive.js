(function() {
    ...
    angular
        .module('oi.controle')
        .directive('customCelPhoneValidator', customCelPhoneValidator);

    /* @ngInject */
    function customCelPhoneValidator($parse) {
        var directive = {
            scope: {
        ...
        function link(scope, element, attrs, ctrl) {
            ctrl.$parsers.push(function(inputValue) {
                ...
                if (valid) {
                    ctrl.$setValidity('celPhoneValid', true);
                    element.removeClass('error-phone');

                } else {
                    ctrl.$setValidity('celPhoneValid', false);
